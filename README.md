...
I am a software engineer and open-source maintainer from Hong Kong, focused on high-performance image processing, Go, C integration, and production infrastructure.

I build tools that make image and media processing faster, safer, and easier to operate.
...
I am available for consulting and engineering support related to:

- designing and extending imagor-based image pipelines
- custom imagor processors, loaders, and storage backends
- multi-tenant image processing deployments
- libvips and Go/C integration
